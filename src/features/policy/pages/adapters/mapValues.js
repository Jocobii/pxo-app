...
export function mapValues(values) {
    return {
        ...
        customer: {
            ...
            name: values.name.split(' ')[0] || null,
            cellPhone: values.cellPhone,
            middle_name: values.is_company ? null : values.name.split(' ')[1] || '',
...
export const formaFormValues = (values) => ({
    ...
    name: `${values.policy_detail.customer.name} ${values.policy_detail.customer.middle_name || ''}`,
